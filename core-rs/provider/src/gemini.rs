...
//!
//! Shared by all Gemini protocol surfaces - `generateContent`,
//! `streamGenerateContent`, and Interactions - because they use the same error
//! envelope. See [`crate::interactions`] and [`crate::adapter`].
