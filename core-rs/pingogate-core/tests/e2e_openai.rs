//! S1 e2e test: OpenAI-compatible Chat Completions passthrough.
//!
...
//!
//! Ported from 001 (`app/pingogate/tests/us1_openai.rs`); verifies the T7/T8
//! five-protocol pipeline still passes the three original protocols.
