...
//!
//! Renders the shared [`Metrics`] registry as Prometheus text exposition. This
//! endpoint is unauthenticated (R1: scrape use); the body is plain text and
//! carries no secret - labels are routing facets and the values are counts
//! (FR-034).
...
mod tests {
    use super::*;
    use pingogate_pipeline::RequestRecord;
