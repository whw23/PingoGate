...
pub(crate) fn classify(err: &AppError) -> ErrorClass {
    match err {
        AppError::UnknownProtocol => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "unknown_protocol",
            anthropic_type: "invalid_request_error",
            gemini_status: "INVALID_ARGUMENT",
        },
        AppError::NoRoute { .. } => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "model_not_found",
            anthropic_type: "not_found_error",
            gemini_status: "NOT_FOUND",
        },
        AppError::UnsupportedCapability { .. } => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "unsupported_capability",
            anthropic_type: "invalid_request_error",
            gemini_status: "INVALID_ARGUMENT",
        },
        AppError::AuthFailed => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "invalid_api_key",
            anthropic_type: "authentication_error",
            gemini_status: "UNAUTHENTICATED",
        },
        AppError::Unauthorized { .. } => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "forbidden",
            anthropic_type: "permission_error",
            gemini_status: "PERMISSION_DENIED",
        },
        AppError::UpstreamUnavailable { .. } => ErrorClass {
            openai_type: "api_error",
            openai_code: "upstream_unavailable",
            anthropic_type: "api_error",
            gemini_status: "UNAVAILABLE",
        },
        AppError::UpstreamTimeout { .. } => ErrorClass {
            openai_type: "api_error",
            openai_code: "upstream_timeout",
            anthropic_type: "api_error",
            gemini_status: "DEADLINE_EXCEEDED",
        },
        AppError::Validation { .. } => ErrorClass {
            openai_type: "invalid_request_error",
            openai_code: "invalid_config",
            anthropic_type: "invalid_request_error",
            gemini_status: "INVALID_ARGUMENT",
        },
        AppError::Internal { .. } => ErrorClass {
            openai_type: "api_error",
            openai_code: "internal_error",
            anthropic_type: "api_error",
